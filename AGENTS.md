...
- Before changing battery-control behavior or configuration gates, read `docs/sigenergy-control-contract.md`, `docs/battery-control-context.md`, and `docs/control-runbook.md`.
